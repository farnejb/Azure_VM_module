...
locals {
  ...
  disk2_size_gb = 150
  virtual_machines = {
    "vm1" = { size = local.vm_size1, location = local.location1, resource_group = local.rg1, subnet_id = local.subnet1_id, disk_size_gb = local.disk1_size_gb },
    "vm2" = { size = local.vm_size2, location = local.location2, resource_group = local.rg2, subnet_id = local.subnet2_id, disk_size_gb = local.disk2_size_gb }
  }
}
